# Autocomplete Bonus Barrels

Makes bonus barrels produce the reward immediately without having to beat the minigame

## Installation
1. Download the latest `autocomplete_bonus.nrm` from Releases.
...
The produced mod file is named `autocomplete_bonus.nrm`.
